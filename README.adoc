...
* RDS Proxy is a fully managed, highly available database proxy, it allows applications to share a pool of database connections, using secrets management for db credentials
